...
function setColorModePreference(mode) {
  ...
  updateDynamicText();
  const currentColorMode = document.body.classList.contains('dark-mode') ? 'dark' : 'light';
  ...
  navList.style.display = navList.style.display === "none" ? "inline" : "none";
  }
  ...
  darkModeBtn.innerText = body.classList.contains("dark-mode") ? "Light Mode" : "Dark Mode";
  }
